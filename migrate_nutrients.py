...
EXTRA = {
    ...
    # ── 피로 관리 보충 ──
    ("fatigue_management", "코엔자임 Q10"): (
        "중간",
        ["소고기", "생선", "브로콜리"],
        "100~200mg 식사와 함께; 스타틴 복용 중이면 주치의와 상담",
    ),
    ("fatigue_management", "비타민 D"): (
        "중간",
        [],
        "하루 15~30분 햇볕 먼저 시도; 부족하면 1000~2000IU 보충",
    ),
    # ── 수면 관리 보충 ──
    ("sleep_management", "비타민 D"): (
        "보통",
        [],
        "햇볕 15~30분이 우선; 보충 시 1000IU, 오전 복용 권장",
    ),
    ("sleep_management", "글리신"): (
        "중간",
        ["닭가슴살", "생선", "두부", "달걀"],
        "취침 전 3g; 천연 아미노산으로 안전성 높음, 부작용 드뭄",
    ),
    # ── 면역 관리 보충 ──
    ("immunity_management", "프로바이오틱스"): (
        "높음",
        ["요거트", "김치", "된장", "청국장"],
        "식사로 발효식품 매일 섭취가 우선; 보충제는 공복 또는 식전 복용",
    ),
    ("immunity_management", "비타민 B12"): (
        "보통",
        ["달걀", "연어", "우유", "치즈"],
        "채식주의자 결핍 주의; 2.4μg/일 권장, 설하정 형태가 흡수에 유리",
    ),
    # ── 뼈 건강 보충 ──
    ("bone_health", "마그네슘"): (
        "중간",
        ["아몬드", "현미", "시금치", "바나나"],
        "300~400mg; 칼슘과 비슷한 비율로 복용, 설사 시 글리시네이트 제형",
    ),
    ("bone_health", "콜라겐"): (
        "보통",
        ["사골국", "닭발", "생선"],
        "2.5~10g 식전 복용; 비타민C와 함께 복용하면 합성 효율 증가",
    ),
    # ── 심혈관 건강 보충 ──
    ("cardiovascular_health", "칼슘"): (
        "보통",
        ["우유", "치즈", "멸치", "두부"],
        "500mg씩 나눠 복용; 심혈관 위험 있으면 음식 섭취 우선 권장",
    ),
    ("cardiovascular_health", "비타민 D"): (
        "중간",
        [],
        "햇볕 15~30분 우선; 부족 시 1000~2000IU — 심혈관 보호 효과 연구 중",
    ),
    ("cardiovascular_health", "비타민 B12"): (
        "보통",
        ["달걀", "연어", "우유", "소고기"],
        "2.4μg/일; 채식주의자나 위장 문제 있으면 설하정 형태 권장",
    ),
}
